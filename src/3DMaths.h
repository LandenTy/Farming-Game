...
inline float degreesToRadians(float degs) {
    return degs * ((float)3.14159265358979323846 / 180.0f);
}
...
inline float4x4 makePerspectiveMat(float aspectRatio, float fovYRadians, float zNear, float zFar)
{
    ...
    // float yScale = tanf((0.5f * 3.14159265358979323846) - (0.5f * fovYRadians));
    float yScale = tanf(0.5f * ((float)3.14159265358979323846 - fovYRadians));
