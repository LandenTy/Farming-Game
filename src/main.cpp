...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
    ...
    HWND hwnd;
    {
        ...
        hwnd = CreateWindowExW(WS_EX_OVERLAPPEDWINDOW,
                                ...
                                L"Farming Game | _LandenBarkerGames",
    ...
    UINT offset;
    {
        LoadedObj obj = loadObj("cube.obj"); // Load Obj File
    ...
    while(isRunning)
    {
        ...
        // Update camera
        {
            ...
            const float CAM_TURN_SPEED = 3.14159265358979323846; // in radians per second
            ...
            while(cameraYaw >= 2*3.14159265358979323846) 
                cameraYaw -= 2*3.14159265358979323846;
            while(cameraYaw <= -2*3.14159265358979323846) 
                cameraYaw += 2*3.14159265358979323846;
        ...
        // Spin the cube
        float4x4 modelMat = rotateXMat(-0.2f * (float)(3.14159265358979323846 * currentTimeInSeconds)) * rotateYMat(0.1f * (float)(3.14159265358979323846 * currentTimeInSeconds)) ;
        ...
        const float backgroundColor[4] = {
			184.0f / 255.0f,   // Red component
			210.0f / 255.0f,   // Green component
			215.0f / 255.0f,   // Blue component
			1.0f               // Alpha component (full opacity)
		};
